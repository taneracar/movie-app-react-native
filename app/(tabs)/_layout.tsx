...
const TabIcon = ({ focused, icon, text }: any) => {
  ...
  return (
    <View className="flex size-full items-center justify-center mt-4 rounded-full">
    ...
    >
      <Tabs.Screen
        ...
        options={{
          ...
          headerShown: false,
          tabBarIcon: ({ focused }) =>
            TabIcon({ focused, icon: icons.home, text: "Home" }),
        }}
      />
      <Tabs.Screen
        name="search"
        options={{
          ...
          headerShown: false,
          tabBarIcon: ({ focused }) =>
            TabIcon({ focused, icon: icons.search, text: "Search" }),
        }}
      />
      <Tabs.Screen
        name="saved"
        options={{
          ...
          headerShown: false,
          tabBarIcon: ({ focused }) =>
            TabIcon({ focused, icon: icons.save, text: "Saved" }),
        }}
      />
      <Tabs.Screen
        name="profile"
        options={{
          ...
          headerShown: false,
          tabBarIcon: ({ focused }) =>
            TabIcon({ focused, icon: icons.person, text: "Profile" }),
        }}
      />
    </Tabs>
  );
